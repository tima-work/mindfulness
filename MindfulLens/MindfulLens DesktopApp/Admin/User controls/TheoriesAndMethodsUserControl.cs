...
{
    public partial class TheoriesAndMethodsUserControl : UserControl
    {
        ...
        public TheoriesAndMethodsUserControl(GraphicFeatures graphicFeatures, EventHandler cognitivePartFunction, CognitivePartManager cognitivePartManager)
        {
            InitializeComponent();
        ...
        {
            CognitivePart[] cognitiveParts = cognitivePartManager.GetCognitiveParts(search_query, sort_method, sort_order, isOfficial, "Theory", load_number + 1);
