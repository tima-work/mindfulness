...
{
    public partial class SourcesUserControl : UserControl
    {
        ...
        public SourcesUserControl(GraphicFeatures graphicFeatures, EventHandler sourceFunction, SourceManager sourceManager)
        {
            InitializeComponent();
        ...
        {
            Source[] sources = sourceManager.GetSources(search_query, sort_method, sort_order, isOfficial, load_number + 1);
            ...
            fullActionMenuLayout.FillContent(graphicSources, showMoreButton, LoadMoreFunction);
            return 1;
        }
