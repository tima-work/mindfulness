...
namespace MindfulLens_DesktopApp.User_controls
{
    public partial class NewsUserControl : UserControl
    {
        ...
        public NewsUserControl(GraphicFeatures graphicFeatures, EventHandler contentFunction, ContentManager contentManager)
        {
            InitializeComponent();
        ...
        {
            int padding = 14;
            Content[] content = contentManager.GetContent(search_query, sort_method, sort_order, "News", load_number + 1);
