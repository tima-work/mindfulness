...
{
    public partial class CustomBiasesUserControl : UserControl
    {
        ...
        public CustomBiasesUserControl(GraphicFeatures graphicFeatures, EventHandler cognitivePartFunc, CognitivePartManager cognitivePartManager)
        {
            InitializeComponent();
        ...
        {
            int padding = 14;
            CognitivePart[] cognitiveParts = cognitivePartManager.GetCognitiveParts(search_query, sort_method, sort_order, false, "Bias", load_number + 1);
