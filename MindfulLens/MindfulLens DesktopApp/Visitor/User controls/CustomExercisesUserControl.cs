...
{
    public partial class CustomExercisesUserControl : UserControl
    {
        ...
        public CustomExercisesUserControl(GraphicFeatures graphicFeatures, EventHandler exerciseFunc, ExerciseManager exerciseManager)
        {
            InitializeComponent();
            ...
            this.exerciseFunction = exerciseFunc;
        ...
        {
            Exercise[] exercises = exerciseManager.GetExercises(search_query, sort_method, sort_order, false, load_number + 1);
            ...
            EqualRowHeightScroll equalRowHeightScroll = new EqualRowHeightScroll(new Size(this.Width - padding * 2, noFilterActionMenuLayout.AddNewButton.Location.Y - (noFilterActionMenuLayout.SortByBlackPanel.Location.Y + noFilterActionMenuLayout.SortByBlackPanel.Height) - 20), new Point(padding, noFilterActionMenuLayout.SortByBlackPanel.Location.Y + noFilterActionMenuLayout.SortByBlackPanel.Height + 10), graphicExercises, graphicFeatures, showMoreButton, LoadMoreFunction);
